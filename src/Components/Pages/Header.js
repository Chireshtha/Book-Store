      ...
      <Container fluid className='d-flex justify-content-center align-items-center'>
        ...
        <Navbar.Collapse id='navbar-nav' clas
          ...
          <Nav className='d-flex justify-content-center align-items-center mx-5 my-4 pt-3 navbar-1'>
            <Nav.Link as={NavLink} to='/Book-Store' className='nav-link custom-nav-item text-decoration-none' onClick={handlemobileDropdownItemClick}> <span>Home</span> </Nav.Link>
